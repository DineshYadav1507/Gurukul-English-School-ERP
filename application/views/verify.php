...
<html lang="en">
    <head>
        ...
        <title><?php echo $this->lang->line('purchase_code'). ' | ' . $this->gsms_setting->school_name;  ?></title>
            ...
            <section>
                <center>
                    <?php if(isset($this->gsms_setting->brand_logo) && !empty($this->gsms_setting->brand_logo)){ ?>
                        <img  src="<?php echo UPLOAD_PATH.'logo/'.$this->gsms_setting->brand_logo; ?>" style="max-width: 100px;" alt="">
                    <?php }else{ ?>
